...
class SimulationViewer:
    ...
    def load_jobs(self):
        ...
        Retrieves job information from the database and updates the job selection
        combobox with formatted job names and IDs.
        """
    ...
    def refresh_jobs(self):
        ...
        Reloads the job list from the database while maintaining the currently
        selected job if it still exists in the updated list.
        """
    ...
    def on_job_selected(self, event=None):
        ...
        Updates the current job ID and loads the corresponding simulation data
        when a job is selected from the combobox.
        """
    ...
    def load_job_data(self, job_id: str):
        ...
        Args:
            job_id: The ID of the job to load data for.
            
        Fetches job results from the server and processes the simulation data,
        updating the internal state and refreshing the plots.
        """
    ...
    def update_parameter_comboboxes(self):
        ...
        Populates the step, TX ID, and RX ID comboboxes with valid values
        based on the loaded simulation data.
        """
    ...
    def on_param_changed(self, event=None):
        ...
        Called when any parameter (step, TX ID, or RX ID) changes,
        triggering a refresh of the plots.
        """
        self.plot_data()
    ...
    def plot_data(self):
        ...
        self.ax_locations.set_xlim([-5, 5])
        self.ax_locations.set_ylim([-5, 5])
